      ...
      cell: (info) => {
        ...
        return (
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-full bg-slate-200 dark:bg-stone-700 overflow-hidden">
              {author?.avatarUrl ? <img src={author.avatarUrl} alt="avatar" /> : <div className="w-full h-full bg-linear-to-bl from-orange-400 to-rose-500" />}
            </div>
  ...
  return (
    <div className="p-8 max-w-[1400px] mx-auto w-full">
      <div className="flex items-end justify-between mb-8">
        <div>
          <h1 className="text-3xl font-extrabold bg-linear-to-r from-orange-500 to-red-600 bg-clip-text text-transparent pb-1">
            커뮤니티 글 관리
          </h1>
