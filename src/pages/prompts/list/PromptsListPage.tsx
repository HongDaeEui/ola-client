...
export default function PromptsListPage() {
  ...
  const columns = [
    ...
    columnHelper.accessor('category', {
      header: '카테고리',
      cell: (info) => (
        <span className="px-2 py-1 bg-slate-100 dark:bg-stone-800 text-slate-600 dark:text-stone-400 rounded-md text-xs font-medium">
          {info.getValue()}
        </span>
      )
    }),
  ...
  return (
    <div className="p-8 max-w-[1400px] mx-auto w-full">
      <div className="flex items-end justify-between mb-8">
        <div>
          <h1 className="text-3xl font-extrabold bg-linear-to-r from-purple-500 to-pink-600 bg-clip-text text-transparent pb-1">
            프롬프트 관리
          </h1>
