# OlaLab Admin-Side Specification (관리자 명세서)

## 1. 아키텍처 개요 (Architecture Overview)
**OlaLab Admin**은 서비스 운영진이 AI 도구, 커뮤니티 게시글, 사용자 정보 등을 효율적으로 검수하고 관리하기 위해 사용하는 **백오피스(Back-Office)** 싱글 페이지 애플리케이션(SPA)입니다.
