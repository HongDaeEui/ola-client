...
1. Call Memverse `search_memory` with query: "learnings for ola"
2. Display in table format:

```
RECENT LEARNINGS (ola)
═══════════════════════════════════════════════════
  #  Type         Key                    Confidence
...
1. Call Memverse `search_memory` with the user's query and domain: "ola"
...
2. Call Memverse `search_memory` with these topics and domain "ola"
...
- **Domain isolation** — always scope to "ola" domain
