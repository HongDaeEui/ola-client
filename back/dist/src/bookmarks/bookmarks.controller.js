...
var BookmarksController_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.BookmarksController = void 0;
const common_1 = require("@nestjs/common");
const jwt = __importStar(require("jsonwebtoken"));
const bookmarks_service_1 = require("./bookmarks.service");
let BookmarksController = BookmarksController_1 = class BookmarksController {
    bookmarksService;
    logger = new common_1.Logger(BookmarksController_1.name);
    ...
    getUserBookmarks(authorization) {
        const userId = this.requireUserIdFromAuthHeader(authorization);
...
exports.BookmarksController = BookmarksController = BookmarksController_1 = __decorate([
