...
async function main() {
    ...
    const dummyTools = [
        ...
        },
        {
            ...
            description: "Arc를 만든 The Browser Company가 선보인 크로미움 기반 AI 브라우저. 주소창과 사이드바에 내장된 AI가 현재 열린 탭과 방문 기록을 맥락으로 이해하고, 즉각적인 요약부터 복잡한 워크플로 자동화까지 실행합니다. 2025년 여름 Pro 구독 모델 도입과 함께 'AI 퍼스트 브라우저' 트렌드의 기폭제가 된 도구입니다.",
        ...
        },
        {
            ...
            description: "Perplexity의 AI 검색 엔진을 심장부에 품은 브라우저. 단순 정보 탐색을 넘어 이메일 발송, 경로 탐색, 구매 완료까지 실제 웹 액션을 수행합니다. 월 $200의 프리미엄 도구에서 무료 전환이라는 파격적인 행보로 세간의 이목을 집중시켰습니다.",
        ...
        },
        {
            ...
            description: 'OpenAI가 GPT 스토어의 진화형으로 선보인 ChatGPT 앱 마켓플레이스. 대화 맥락을 분석해 적합한 앱을 자동 추천하고 실행하는 에이전트형 구조로, 크리에이터에게는 사용량 기반 수익 배분을 제공합니다. 거대한 사용자 기반 위에 새로운 앱 경제를 구축하는 야심찬 프로젝트입니다.',
        ...
        },
        {
            ...
            description: 'OpenAI의 2세대 텍스트-투-비디오 모델. 사실적인 영상과 음성 합성, 그리고 크리에이터 본인을 영상에 삽입하는 카메오 기능으로 업계를 놀라게 했습니다. Runway, Veo 대비 높은 일관성으로 단편 광고, 티저, 나레이티브 영상 제작의 기준을 새로 세운 도구입니다.',
            category: '영상 생성',
        ...
        },
        {
            ...
            description: 'Google DeepMind가 공개한 에이전트 특화 LLM. 스크린샷을 시각적으로 분석하고 클릭, 스크롤, 텍스트 입력까지 UI를 직접 제어합니다. 브라우저 테스트 자동화, 폼 대량 처리, RPA 대체 솔루션으로 빠르게 주목받고 있는 혁신적인 모델입니다.',
        ...
        },
        {
            ...
            description: 'Gmail, Docs, Sheets, Meet, Drive 전반에 깊숙이 통합된 엔터프라이즈 AI 플랫폼. 사내 데이터 기반 의미 검색, 문서 자동 생성, 간편한 에이전트 빌더를 하나의 구독으로 제공합니다. Google 생태계 헤비유저라면 즉시 생산성 극대화를 체감할 수 있는 도구입니다.',
        ...
        },
        {
            ...
            description: 'Power Platform 위에서 챗봇과 코파일럿을 시각적으로 구축하는 로우코드 빌더. Teams, 웹, 모바일 채널에 에이전트를 원클릭 배포하고, M365, Dynamics, Power Automate와 매끄럽게 연동됩니다. Microsoft 생태계 안에서 에이전트 자동화를 시작하는 가장 빠른 관문입니다.',
        ...
        },
        {
            ...
            description: "Anthropic이 직접 에이전트 실행 환경, 샌드박스, 멀티에이전트 조율을 관리해주는 엔터프라이즈 플랫폼. 프로토타입에서 프로덕션까지의 여정을 '수개월에서 수일'로 단축하는 것을 목표로 합니다. 세션 지속성과 툴 실행 환경까지 포함한 올인원 에이전트 인프라입니다.",
        ...
        },
        {
            ...
            description: "Claude 데스크톱 앱의 'Cowork' 모드는 단순한 채팅창을 넘어 실제 로컬 폴더에 접근하고, 문서 편집, 코드 수정, 리서치 정리를 여러 단계에 걸쳐 자율적으로 수행합니다. 옆자리에 앉은 똑똑한 동료처럼, 지시하면 알아서 실행하는 에이전트형 생산성 경험입니다.",
        ...
        },
        {
            ...
            description: '1,500만 달러 투자를 등에 업고 등장한 SMB 타깃 AI 고객 경험 플랫폼. 음성 봇과 디지털 에이전트, 실시간 품질 모니터링, 고객 피드백 분석을 하나의 서비스로 통합합니다. 작은 팀이 대기업 수준의 고객 응대를 실현할 수 있다는 비전을 담고 있습니다.',
        ...
        },
        {
            ...
            description: '엑셀러레이터, 공공 스타트업 지원 기관을 위해 설계된 AI 기반 프로그램 관리 플랫폼. 참가자 온보딩, 마일스톤 추적, 성과 대시보드를 하나의 인터페이스로 통합해 운영 효율을 대폭 높입니다. 창업 생태계 운영자들의 숨은 니즈를 정확히 짚은 버티컬 솔루션입니다.',
        ...
        },
        {
            ...
            description: '팀원에게 설명하듯 자연어로 업무를 기술하면, 수천 개 앱과 연결된 다단계 에이전트 워크플로가 자동으로 완성됩니다. 영업, 운영, 재무를 망라하는 전사 자동화를 노코드로 구현한다는 담대한 비전을 가진 플랫폼입니다.',
        ...
        },
        {
            ...
            description: 'Microsoft Ignite 2025에서 공개된 에이전트 개발 플랫폼. Semantic Kernel과 AutoGen을 통합한 Agent Framework SDK와, 기업 수준의 보안·거버넌스를 갖춘 Foundry 플랫폼으로 구성됩니다. Azure 생태계 개발자에게 에이전트 프로덕션의 완전한 레일을 제공합니다.',
        ...
        },
        {
            ...
            description: '다수의 AI 에이전트와 모델을 유기적으로 라우팅하고, 엔터프라이즈 수준의 보안과 거버넌스를 제공하는 Azure 기반 AI 오케스트레이션 서비스. 복잡한 멀티에이전트 워크플로를 안정적으로 운용하고자 하는 기업의 핵심 인프라로 자리잡고 있습니다.',
        ...
        },
        {
            ...
            description: "아이디어 검증부터 고투마켓 전략까지 창업 전 여정을 함께하는 'Intelligent Business Canvas' 플랫폼. AI가 아이디어를 정제하고, 리스크를 진단하고, 실행 우선순위를 제안합니다. 잘못된 방향으로 오래 달리는 창업의 실수를 원천 차단하는 것이 핵심 가치입니다.",
        ...
        },
        {
            ...
            description: 'Stack Overflow와 Stack Exchange의 방대한 검증 Q&A를 주지식원으로 활용하고, 필요할 때만 LLM을 보조로 사용하는 하이브리드 개발자 도구. 에러 디버깅, 라이브러리 비교, 아키텍처 설계에서 28만 명 이상의 베타 개발자가 신뢰를 확인해 준 도구입니다.',
            category: '개발자 도구 · Q&A',
            pricingModel: '완전 무료',
            rating: 4.3,
            tags: ['개발자도구', '디버깅', '무료'],
        ...
        },
        {
            ...
            description: "Google Labs와 DeepMind가 공동으로 선보인 소규모 비즈니스용 마케팅 AI. 웹사이트 URL만 입력하면 폰트, 색상, 톤앤매너를 분석해 'Business DNA'를 생성하고, 일관된 브랜드 아이덴티티를 유지하는 소셜 및 광고 크리에이티브를 즉시 제작합니다. 2026년 초 영상 생성 기능까지 확장되었습니다.",
        ...
        },
        {
            ...
            description: '수의사, 영양, 행동, 혈액검사, 영상 판독 등 10개의 특화 에이전트를 하나의 플랫폼 안에 통합한 반려동물 헬스케어 서비스. Web3 토크노믹스를 결합해 데이터 공유에 토큰 보상을 제공하는 혁신적 모델로 크립토 커뮤니티에서도 큰 반향을 일으켰습니다.',
        ...
        },
        {
            ...
            description: 'Elon Musk의 xAI가 공개한 Grok 시리즈의 최신작. 주 단위 모델 개선과 멀티에이전트 아키텍처, X 플랫폼의 실시간 데이터 접근이 최대 강점입니다. 자동 트레이딩, 실시간 소셜 분석, 트렌드 기반 에이전트 구축 시나리오에서 독보적인 포지션을 점하고 있습니다.',
    ...
    await prisma.prompt.createMany({
        data: [
            ...
            },
            {
                ...
                toolName: 'Midjourney v6.5',
                category: '이미지',
                content: '/imagine prompt: A serene Korean countryside village in Studio Ghibli animation style, vibrant green rice paddies, mountains in the background, warm golden sunset light, hand-painted watercolor texture, nostalgic and peaceful atmosphere --ar 16:9 --v 6.5 --style raw',
                authorId: creator1.id,
                likes: 287,
                views: 3100,
            },
            {
                ...
                toolName: 'DALL·E 3',
                category: '이미지',
                content: 'Create a cute minimalist 3D isometric illustration of a home office setup. Include a desk with a MacBook, a small cactus plant, noise-canceling headphones, a latte in a ceramic cup, and warm ambient lighting from a desk lamp. Soft pastel color palette with subtle shadows. White background.',
                authorId: creator2.id,
                likes: 198,
                views: 2400,
            },
            {
                ...
                toolName: 'DALL·E 3',
                category: '이미지',
                content: 'Transform this product photo: Place the item on a beautiful marble kitchen countertop with morning sunlight streaming through a window, soft bokeh background with green plants, professional product photography lighting, commercial quality, 4K resolution.',
                authorId: admin.id,
                likes: 156,
                views: 1800,
            },
            {
                ...
                toolName: 'Midjourney v6.5',
                category: '이미지',
                content: '/imagine prompt: Ultra-clean app store screenshot mockup, iPhone 15 Pro floating at 15-degree angle, modern finance app UI on screen showing charts and cards, gradient background from deep purple to midnight blue, soft light reflections on glass, professional presentation --ar 9:19 --v 6.5',
                authorId: creator2.id,
                likes: 342,
                views: 4200,
            },
            ...
            },
            {
                ...
                category: '텍스트',
                content: '다음 회의 녹취록을 분석해서 아래 형식으로 정리해줘:\n\n## 📋 회의 요약 (3줄 이내)\n\n## ✅ 액션 아이템\n| 번호 | 할 일 | 담당자 | 마감일 | 우선순위 |\n|------|-------|--------|--------|----------|\n\n## ⚠️ 미결 사안\n- 추가 논의가 필요한 사항\n\n## 💡 주요 인사이트\n- 회의에서 나온 핵심 아이디어나 결정사항\n\n녹취록:\n[여기에 회의 내용 붙여넣기]',
                authorId: creator2.id,
                likes: 523,
                views: 7800,
            },
